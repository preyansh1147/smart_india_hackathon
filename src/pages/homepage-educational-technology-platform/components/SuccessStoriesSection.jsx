...
const SuccessStoriesSection = () => {
  ...
  const successStories = [
    ...
    {
      id: 3,
      name: 'Meera Krishnan',age: 17,location: 'Chennai, Tamil Nadu',previousPath: 'Rural background with limited career awareness',currentPath: 'MBBS at Government Medical College',story: `Coming from a small village, I had no idea about career options beyond basic jobs. PathFinder Pro's multilingual support in Tamil helped me understand various possibilities. The scholarship guidance was invaluable - I secured a full scholarship for my medical studies. This platform truly democratizes career guidance.`,
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-text-secondary max-w-3xl mx-auto">
            Meet students who transformed their confusion into clarity and achieved their educational goals with PathFinder Pro
          </p>
        </div>
